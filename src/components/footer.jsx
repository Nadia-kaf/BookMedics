...
<footer>
    ...
    <div class="bg-foot-blue py-4 text-gray-100">
      <div class="container mx-auto px-4">
        <div class="-mx-4 flex flex-wrap justify-between">
          <div class="px-4 w-full text-center mx-auto sm:w-auto sm:text-left">
            Copyright © 2020 BookMedics. All Rights Reserved.
          </div>
        </div>
      </div>
    </div>
