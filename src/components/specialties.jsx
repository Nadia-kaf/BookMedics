...
export default function Specialties() {
  return (
    <div class="bg-gradient-to-r from-deep-blue to-foot-blue border rounded-2xl">
      <section
        id="features"
        class="relative block px-6  md:py-20 md:px-10  border-t border-b border-neutral-900 bg-neutral-900/30"
      >
        <div className="flex justify-end">
          <Link
            to="/searchS"
            class="flex items-center text-white border border-deep-blue py-2 px-6 gap-2 rounded inline-flex items-center "
          >
            <span>View All</span>
            <svg
              fill="none"
        ...
        <div class="relative mx-auto max-w-7xl z-10 grid grid-cols-1 gap-10 pt-14 sm:grid-cols-2 lg:grid-cols-3">
          <div class="rounded-md border border-neutral-800 bg-neutral-900/50 p-8 text-center shadow">
            ...
            <h3 class="mt-6 text-gray-400">Dental</h3>
          ...
          <div class="rounded-md border border-neutral-800 bg-neutral-900/50 p-8 text-center shadow">
            ...
            <h3 class="mt-6 text-gray-400">Orthopaedic</h3>
            <p class="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-400">
          ...
          <div class="rounded-md border border-neutral-800 bg-neutral-900/50 p-8 text-center shadow">
            ...
            <h3 class="mt-6 text-gray-400">Cardiologist</h3>
            <p class="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-400">
              We build our templates for speed in mind, for super-fast load
              times so your customers never waver.
            </p>
          ...
          <div class="rounded-md border border-neutral-800 bg-neutral-900/50 p-8 text-center shadow">
            ...
            <h3 class="mt-6 text-gray-400">Dietician</h3>
            <p class="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-400">
              We build our templates for speed in mind, for super-fast load
              times so your customers never waver.
            </p>
          ...
          <div class="rounded-md border border-neutral-800 bg-neutral-900/50 p-8 text-center shadow">
            ...
            <h3 class="mt-6 text-gray-400">Opthomologist</h3>
            <p class="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-400">
              We build our templates for speed in mind, for super-fast load
              times so your customers never waver.
            </p>
          ...
          <div class="rounded-md border border-neutral-800 bg-neutral-900/50 p-8 text-center shadow">
            ...
            <h3 class="mt-6 text-gray-400">Speech therapist</h3>
            <p class="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-400">
