...
export default function SignUpH() {
    return (
      <div className="min-h-screen   flex flex-col justify-center sm:py-12"style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.6)),url(${med})`, backgroundSize: 'cover', backgroundPosition: 'center', height:"280px" }}>
    ...
    <div class="relative px-6 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-10">
      ...
      <div class="max-w-md mx-auto px-10">
        <div>
          <h1 class="text-2xl font-semibold">Register as a Health Professional</h1>
        </div>
        <div class="divide-y divide-gray-200">
          <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
            ...
            <div class="relative">
              <input autocomplete="off" id="email" name="email" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Email address" />
              <label for="email" class="absolute left-0 -top-3.5 text-gray-600 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-gray-600 peer-focus:text-sm">Profession</label>
            </div>
            <div class="relative">
              <input autocomplete="off" id="email" name="email" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Email address" />
          ...
          <p className="text-gray-600 text-sm">Already have an account as  Health Professional?</p><a className="text-gray-600 text-sm underline"
            href="/loginH">log in</a>
        </div>  
    </div>
  </div>
</div>
